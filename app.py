...
resamplerss = {"8000": resampler_8000, "44100":resampler_44100, "48000": resampler_48000}
...
description = """This is a speechbrain-based Automatic Speech Recognition (ASR) model for Tunisian arabic. It outputs Tunisian transcriptions written in Arabic alphabet. Since the language is unwritten, the words' transcriptions may vary
...
import gradio as gr
def treat_wav_file(file_mic, file_upload, resamplers = resamplerss,asr=asr_brain, device="cpu") :
    ...
    resampled = resamplerss[str(sr)](tensor_wav)
